import 'package:elifbauygulamasi/AdminScreens/detay/bitisikdetay.dart';
...
class BitisikListe extends StatefulWidget {
  BitisikListe({
    Key? key,
    required this.user,
  ...
  @override
  State<BitisikListe> createState() => _BitisikListeState();
}

class _BitisikListeState extends State<BitisikListe> {
  ...
  Widget kutuu(BitisikHarfler harf1) {
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => BitisikDetay(
                    denemeiki: widget.denemeiki,
                    user: widget.user,
                    deneme: widget.deneme,
                    harf: harf1,
