...
class ListePage extends StatefulWidget {
  final User user;
  final int deneme;
  ListePage({Key? key, required this.user,required this.deneme}) : super(key: key);
  @override
...
class _ListePage extends State<ListePage> {
  ...
  Widget kutuu(Letter letters) {
    return InkWell(
      onTap: (){Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => DetayPage(letter: letters,user: widget.user,deneme: widget.deneme,)),);},
      child: Container(
