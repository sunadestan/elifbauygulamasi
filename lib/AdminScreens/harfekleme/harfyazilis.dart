...
class HarfYazilisEkle extends StatefulWidget {
  const HarfYazilisEkle({Key? key,required this.user,required this.letter,required this.deneme,}) : super(key: key);
  final User user;
  final Letter letter;
  final int deneme;
      ...
      onPressed: () async {
        if (_formKey.currentState!.validate()) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => HarfYazilisListePage(user: widget.user,deneme: deneme,)),);
