...
class _YazilisPageState extends State<YazilisPage> with ValidationMixin {
  ...
  @override
  void initState() {
    txtlettername.text = harf.harfname!;
    txtletterannotation.text = harf.harfannotation!;
    super.initState();
  ...
  Future<void> _loadAudio() async {
    try {
      await audioPlayer.setUrl(musicPath ?? widget.harf.harfmusicPath!);
    } catch (e) {
